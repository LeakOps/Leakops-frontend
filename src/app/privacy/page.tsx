        ...
        <Card padding="lg" className="space-y-6 text-sm text-[#6B7280] dark:text-gray-300 leading-relaxed">
          <section>
            ...
            <p>
              ...
              (e.g., charge failure metadata, invoice updates), and account information
              necessary to identify revenue leaks and automate recovery operations.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              All payment credentials and webhook communications are encrypted in transit
              and at rest using bank-grade AES-256 protocols. We never store raw card numbers
              or sensitive payment methods on our servers.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:support@leakops.com" className="text-[#6366F1] underline">
                support@leakops.com
              </a>
              .
            </p>
